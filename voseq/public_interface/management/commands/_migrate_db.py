...
class ParseXML(object):
    ...
    def save_table_primers_to_db(self):
        ...
        for item in self.table_primers_items:
            try:
                b = Sequence.objects.get(code=item['code'], gene_code=item['gene_code'])
                item['for_sequence'] = b
