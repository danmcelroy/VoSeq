...
from public_interface.models import FlickrImage
from public_interface.models import Primer
...
class TestCustomCommand(TestCase):
    ...
    def test_orden_none(self):
        b = Voucher.objects.get(code='CP100-09')
    ...
    def test_orden_space(self):
        b = Voucher.objects.get(code='CP100-12')
        self.assertEqual('', b.orden)
    ...
    def test_family_space(self):
        b = Voucher.objects.get(code='CP100-11')
        self.assertEqual('', b.family)
    ...
    def test_accession(self):
        b = Sequence.objects.get(code='CP100-10', gene_code='EF1a')
    ...
    def test_max_altitude2(self):
        b = Voucher.objects.get(code='CP100-13')
        self.assertEqual(2500, b.max_altitude)

    def test_max_altitude3(self):
        b = Voucher.objects.get(code='CP100-14')
    ...
    def test_voucher_image(self):
        b = Voucher.objects.get(code='CP100-09')
        c = FlickrImage.objects.all().filter(voucher=b)
    ...
    def test_primers(self):
        b = Sequence.objects.get(code='CP100-10', gene_code='EF1a')
        c = Primer.objects.filter(for_sequence=b)

        primers_f = [i.primer_f for i in c]
        self.assertTrue('Cho', primers_f)

    def test_primers_some_none(self):
        b = Sequence.objects.get(code='CP100-10', gene_code='wingless')
        c = Primer.objects.filter(for_sequence=b)
    ...
    def test_geneset_name(self):
        b = GeneSet.objects.get(geneset_name='4genes')
    ...
    def test_geneset_description_empty(self):
        b = GeneSet.objects.get(geneset_name='2genes')
    ...
    def test_taxonset_name(self):
        b = TaxonSet.objects.get(taxonset_name='Erebia')
