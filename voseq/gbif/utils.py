...
def create_excel_file():
    ...
    for voucher in vouchers:
        ...
        row.append(get_type_species(voucher.type_species))
        row.append(voucher.country)
        row.append(voucher.specific_locality)
        ...
        row.append(voucher.date_collection)
        row.append(voucher.voucher_locality)
        ...
        row.append(voucher.extraction_tube)
        row.append(voucher.published_in)
