...
This can only be done for aligned genes/alignments!</br>
			...
			<table border="0" width="800px" cellspacing="0" cellpadding="0px">
				...
				<tr>
					...
					<table border="0">
						<tr>
						<td>
						<tr><td><input type="radio" name="decimal" value='comma' checked>comma(,)</td></tr> 
						<tr><td><input type="radio" name="decimal" value='dot'>dot(.)<td></tr>
						</td>
						</tr>
					</table>
					</td>
