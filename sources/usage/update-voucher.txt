...
When you **click on the code** of an already existing voucher in the
**administrator interface** you will be transferred to it's **voucher information page**.

Here you may make changes to all the fields - and these will be updated after
pressing the **Save**, **Save and continue editing** or **Save and add another**
buttons.
