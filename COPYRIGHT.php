...
VoSeq derives from copyrighted works licensed under the GNU General
Public License.  This version has been modified pursuant to the
GNU General Public License as of October 04, 2007, and as distributed,
...
VoSeq includes or is derivative of works distributed under the following copyright notices:

- Copyright (c) 2006, PHPSense.com
- Dojo
- Validate.php
- Translation tools:
	// This is a modified script retrieveing the functions from a script
