...
echo "<!--standard page header begins-->
		<div id=\"header\">
	   	...
	   	" . $intro_msg. "
			...
			<b>3.</b> You can add a single record by clicking on the link <b>Add new record</b>. <a href=\"http://carlosp420.github.io/VoSeq/#adding-vouchers\">See more help.</a><br />	
			<b>4.</b> You can upload voucher photos by clicking on the link <b>Picture missing</b> or the <b>Change picture</b> icon. <a href=\"http://carlosp420.github.io/VoSeq/#upload-voucher-photos\">See more help.</a>
			</p>
		</div>
...
function make_footer($date_timezone, $config_sitename, $version, $base_url, $p_) {
	...
	if( $mask_url == "true" ) {
		echo "\n <a href=\"" . $base_url . "/home.php\" onclick=\"return redirect('" . $base_url . "/changelog.php');\" title='check verion history' >version " . $version . "</a>";
		...
		echo "\n <a href=\"" . $base_url . "/changelog.php\" title='check verion history' >version " . $version . "</a>";
