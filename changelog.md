...
* Version 1.5.0
	...
	- [Tobias 2013-03-12] Created gene/alignment (xml) table output with characteristics for a given alignent,
	...
	- [Tobias 2013-03-12] Included new gene information in the data set retrieval scripts. It ignores introns by
							default. Genetic codes for amino acids translations are now set at gene info page.
							"Special" data set now also includes AA, AA paritions and dna paritions are now 
							combineable in the same data set and specified as such in the output files.
							AA partitions will not be made of protein code is set to no.
	- [Tobias 2013-03-10] Changed gene information to include more fields, including protein coding or not,
